...
def main():
    ...
    train_dataset = dataset_dict["train"]  #.select(range(50_000))
    ...
    loss = CachedMultipleNegativesRankingLoss(model, mini_batch_size=256)  # Increase mini_batch_size if you have enough VRAM
...
if __name__ == "__main__":
    # CUDA_VISIBLE_DEVICES=6,7 accelerate launch --num_processes 2 --main_process_port 29502 train_st.py
    main()